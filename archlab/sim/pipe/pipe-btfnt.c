...
long long gen_f_pc()
{
    return (((((ex_mem_curr->icode) == (I_JMP)) & !((ex_mem_curr->ifun) == 
            (C_YES))) & ((((ex_mem_curr->vala) == (ex_mem_curr->vale)) & !
            (ex_mem_curr->takebranch)) | (((ex_mem_curr->vala) > 
              (ex_mem_curr->vale)) & (ex_mem_curr->takebranch)))) ? 
...
long long gen_aluA()
{
    return (((id_ex_curr->icode) == (I_RRMOVQ) || (id_ex_curr->icode) == 
        (I_ALU) || (id_ex_curr->icode) == (I_JMP)) ? (id_ex_curr->vala) : (
...
{
    return ((((((id_ex_curr->valc) > (id_ex_curr->vala)) | (
       ...
       : (((((id_ex_curr->icode) == (I_JMP)) & !((id_ex_curr->ifun) == 
        ...
        (ex_mem_next->takebranch)) ? (id_ex_curr->valc) : 
      (id_ex_curr->vala));
}
